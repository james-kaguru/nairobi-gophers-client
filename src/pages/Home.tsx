...
function Sponsors() {
  return (
    <section
      className={
        "py-8 md:flex md:flex-row items-center md:h-[50vh] md:px-12 md:gap-[150px]"
      }
    >
...
function CallForSpeakers() {
  return (
    <section className=" py-8 md:flex md:flex-row items-center md:h-[50vh] md:px-12 md:gap-[150px] bg-accent">
